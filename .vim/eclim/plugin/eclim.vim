...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/usr/local/google/users/mjohns/eclipse37/stable/plugins/org.eclim_1.7.3'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/usr/local/google/users/mjohns/eclipse37/stable'
  if has('win32unix')
